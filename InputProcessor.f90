MODULE InputProcessor
 ...
 USE DataGlobals, ONLY: MaxNameLength,AutoCalculate,rTinyValue, DisplayAllWarnings,DisplayUnusedObjects,  &
                        CacheIPErrorFile,DoingInputProcessing
 USE DataInterfaces, ONLY: ShowFatalError, ShowSevereError, ShowWarningError, ShowContinueError, ShowMessage, ShowErrorMessage
