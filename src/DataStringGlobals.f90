...
PUBLIC          ! By definition, all variables which are placed in this data
       ...
       'àáâãäåæçèéêëìíîïğñòóôõöøùúûüıÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖØÙÚÛÜİABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'
          ...
          CHARACTER(len=120) :: VerString='EnergyPlus, Version 8.8'      ! String that represents version information
          CHARACTER(len=5)   :: MatchVersion='8.8.0' ! String to be matched by Version object
